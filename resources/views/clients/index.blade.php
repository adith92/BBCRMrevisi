...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <table class="w-full text-sm">
        <thead class="bg-gray-50"><tr><th class="px-4 py-3 text-left">Company</th><th class="px-4 py-3 text-left">PIC</th><th class="px-4 py-3 text-left">Industry</th><th class="px-4 py-3 text-left">Sales</th><th class="px-4 py-3 text-left">Status</th><th class="px-4 py-3">Actions</th></tr></thead>
        <tbody>
        ...
        @empty
        <tr><td colspan="6" class="px-4 py-6 text-center text-gray-400">No clients</td></tr>
        @endforelse
        </tbody>
    </table>
