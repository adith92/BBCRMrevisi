...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="{{ route('finance.index', ['filter' => 'month']) }}" class="group block bg-white rounded-lg shadow p-6 border-l-4 border-green-500 hover:shadow-md hover:bg-green-50 transition-all">
        ...
        <a href="{{ route('finance.index', ['status' => 'sent']) }}" class="group block bg-white rounded-lg shadow p-6 border-l-4 border-yellow-500 hover:shadow-md hover:bg-yellow-50 transition-all">
        ...
        <a href="{{ route('finance.index', ['status' => 'overdue']) }}" class="group block bg-white rounded-lg shadow p-6 border-l-4 border-red-500 hover:shadow-md hover:bg-red-50 transition-all">
