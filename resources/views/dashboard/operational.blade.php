...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="{{ route('fleet.index', ['status' => 'available']) }}" class="group block bg-white rounded-lg shadow p-6 border-l-4 border-green-500 hover:shadow-md hover:bg-green-50 transition-all">
        ...
        <a href="{{ route('fleet.index', ['status' => 'on_trip']) }}" class="group block bg-white rounded-lg shadow p-6 border-l-4 border-blue-500 hover:shadow-md hover:bg-blue-50 transition-all">
        ...
        <a href="{{ route('maintenance.index') }}" class="group block bg-white rounded-lg shadow p-6 border-l-4 border-yellow-500 hover:shadow-md hover:bg-yellow-50 transition-all">
        ...
        <a href="{{ route('bookings.index', ['status' => 'active']) }}" class="group block bg-white rounded-lg shadow p-6 border-l-4 border-purple-500 hover:shadow-md hover:bg-purple-50 transition-all">
